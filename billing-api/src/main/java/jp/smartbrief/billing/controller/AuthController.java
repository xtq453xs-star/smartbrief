...
public class AuthController {
    ...
    public AuthController(jp.smartbrief.billing.repository.UserRepository userRepository, PasswordEncoder passwordEncoder, jp.smartbrief.billing.util.JwtUtil jwtUtil) {
